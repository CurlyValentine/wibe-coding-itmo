...
![Приветственное сообщение с описанием команд](screenshots/2025-10-24%2011.04.37.jpg)

#### 2. Добавление задачи

![Процесс добавления задачи с выбором приоритета](screenshots/2025-10-24%2011.05.55.jpg)

#### 3. Список задач

![Отображение задач, сгруппированных по приоритетам](screenshots/2025-10-24%2011.17.15.jpg)

#### 4. Установка напоминания

![Выбор времени напоминания с кнопками](screenshots/2025-10-24%2011.18.01.jpg)

#### 5. Завершение задачи

![Отметка задачи как выполненной](screenshots/2025-10-24%2011.18.43.jpg)

### Видео-демонстрация

<!-- Вставьте ссылку на видео -->

**Ссылка на видео:** https://disk.yandex.com/i/iOYYDlSO8rAZEg
